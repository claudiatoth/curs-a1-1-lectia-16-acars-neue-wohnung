...
(function () {
    ...
    function buildTheory() {
        ...
        return `<h1 class="chapter">📘 1. Teorie — Wohnen + Möbel + „in" + Dativ pentru locație</h1>` + t;
    }
    ...
    function buildExercises() {
        ...
        if (typeof ex1Data !== 'undefined') {
            html += fillInBlock('Übung 1 — Articolul hotărât pentru camere (die Räume)', 'das Wohnzimmer, das Schlafzimmer, das Esszimmer, das Badezimmer, die Küche, der Flur, der Balkon. Toate „-zimmer" sunt NEUTRE (das).', ex1Data);
        }
        if (typeof ex2Data !== 'undefined') {
            html += fillInBlock('Übung 2 — Articolul hotărât pentru mobilă (Möbel)', 'das Sofa, das Bett, der Stuhl, der Tisch, der Schrank, die Lampe, die Couch, das Regal.', ex2Data);
        }
        if (typeof ex3Data !== 'undefined') {
            html += fillInBlock('Übung 3 — „in" + Dativ pentru locație (răspunde la WO?)', 'in + dem = IM (m, n): im Wohnzimmer, im Schlafzimmer · in + der = IN DER (f): in der Küche · in + den = IN DEN +n (pl.).', ex3Data);
        }
        if (typeof ex4Data !== 'undefined') {
            html += fillInBlock('Übung 4 — Asociere obiect → cameră ↔ acțiune', 'Acțiunile naturale: în Bett (pat) → schlafen · în Tisch (masă) → essen · în Schrank → Kleidung. Logică spațială.', ex4Data);
        }
        if (typeof ex5Data !== 'undefined') {
            html += fillInBlock('Übung 5 — Tot apartamentul lui Acar (descrierea camerelor)', 'Pattern descriere: „Im Erdgeschoss gibt es ein Wohnzimmer." · „In der Küche steht ein Tisch." · „Im Schlafzimmer ist das Bett."', ex5Data);
        }
        return html;
    }
